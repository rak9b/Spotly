      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-gray-900">LocalGuide<span className="text-indigo-600">.ai</span></span>
          </Link>

          {/* Desktop Navigation */}
          <div className="hidden md:flex md:items-center md:gap-6">
            <Link to="/explore" className="text-sm font-medium text-gray-600 hover:text-indigo-600 transition-colors">
              Explore
            </Link>
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="flex items-center gap-3">
                  <Link to="/settings" className="flex items-center gap-2 group">
                    <span className="text-sm text-gray-700 group-hover:text-indigo-600 transition-colors">Hi, {userName}</span>
                    {userAvatar ? (
                      <img src={userAvatar} alt="Profile" className="h-8 w-8 rounded-full object-cover border border-gray-200 group-hover:ring-2 group-hover:ring-indigo-100 transition-all" />
                    ) : (
              ...
              <>
                <Link to="/login?role=guide" className="text-sm font-medium text-gray-600 hover:text-indigo-600">
                  Become a Guide
                </Link>
          ...
          >
            <div className="space-y-1 px-4 pb-3 pt-2">
              <Link
                ...
                className="flex items-center gap-2 rounded-md px-3 py-2 text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-indigo-600"
              >
